package cn.i7baoz.gen.introspector;
...
import cn.i7baoz.gen.factory.MyObjectFactory;
 ...
 * @date 2018/9/14
 **/
public class MyDatabaseIntrospector {
    ...
    public MyDatabaseIntrospector(MyContext context,
    ...
    private void reportIntrospectionWarnings(
            IntrospectedTable introspectedTable,
            MyTableConfiguration tableConfiguration, FullyQualifiedTable table) {
     ...
     * @throws SQLException
     */
    public List<IntrospectedTable> introspectTables(MyTableConfiguration tc)
            throws SQLException {
     ...
     * @param columns
     */
    private void removeIgnoredColumns(MyTableConfiguration tc,
    ...
    private void calculateExtraColumnInformation(MyTableConfiguration tc,
            Map<ActualTableName, List<IntrospectedColumn>> columns) {
    ...
    private void calculateIdentityColumns(MyTableConfiguration tc,
            Map<ActualTableName, List<IntrospectedColumn>> columns) {
    ...
    private void applyColumnOverrides(MyTableConfiguration tc,
            Map<ActualTableName, List<IntrospectedColumn>> columns) {
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
                .entrySet()) {
            for (IntrospectedColumn introspectedColumn : entry.getValue()) {
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
            MyTableConfiguration tc) throws SQLException {
        String localCatalog;
        String localSchema;
        ...
        while (rs.next()) {
            IntrospectedColumn introspectedColumn = MyObjectFactory
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns
            ...
            IntrospectedTable introspectedTable = MyObjectFactory
