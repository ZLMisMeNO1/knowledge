package cn.i7baoz.gen.generator;
...
public class MyBatisGenerator {
     ...
     */
    public MyBatisGenerator(MyConfiguration configuration, ShellCallback shellCallback,
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        if (configuration.getClassPathEntries().size() > 0) {
            ...
            MyObjectFactory.addExternalClassLoader(classLoader);
        }
