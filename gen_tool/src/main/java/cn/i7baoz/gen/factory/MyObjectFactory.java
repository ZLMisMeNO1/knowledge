...
import cn.i7baoz.gen.mybatisimpl.MyIntrospectedTableMyBatis3Impl;
...
public class MyObjectFactory {
    ...
    public static synchronized void addResourceClassLoader(
        ...
        MyObjectFactory.resourceClassLoaders.add(classLoader);
    }
    ...
    public static synchronized void addExternalClassLoader(
            ClassLoader classLoader) {
        MyObjectFactory.externalClassLoaders.add(classLoader);
    }
    ...
    public static Class<?> internalClassForName(String type)
        ...
        if (clazz == null) {
            clazz = Class.forName(type, true, MyObjectFactory.class.getClassLoader());
        }
    ...
    public static URL getResource(String resource) {
        ...
        if (url == null) {
            url = MyObjectFactory.class.getClassLoader().getResource(resource);
        }
    ...
    public static JavaTypeResolver createJavaTypeResolver(MyContext context,
    ...
    public static Plugin createPlugin(MyContext context,
    ...
    public static CommentGenerator createCommentGenerator(MyContext context) {
    ...
    public static IntrospectedTable createIntrospectedTableForValidation(MyContext context) {
        ...
        if (!stringHasValue(type)) {
            type = MyIntrospectedTableMyBatis3Impl.class.getName();
